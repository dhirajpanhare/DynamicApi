    ...
    public class SwaggerSchemaGenerator
    {
        ...
        private string MapSqlTypeToJsonType(string sqlType)
        {
            return sqlType.ToLower() switch
            {
                ...
                _ => "string"  // Default to string for varchar, nvarchar, text, etc.
            };
        }
        ...
        private object GenerateExampleValue(string sqlType)
        {
            return sqlType.ToLower() switch
            {
                ...
                "float" or "real" or "decimal" or "numeric" or "money" or "smallmoney" => 99.99,
                "bit" => true,
                "datetime" or "datetime2" or "date" or "time" or "datetimeoffset" => DateTime.UtcNow.ToString("yyyy-MM-ddTHH:mm:ss"),
                "guid" or "uniqueidentifier" => Guid.NewGuid().ToString(),
                _ => "example_value"
            };
        }
